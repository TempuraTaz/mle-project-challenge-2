...
Evaluates the baseline house price prediction model performance and generalization.
...
RANDOM_STATE = 42  # Must match create_model.py
...
def load_model():
    ...
    try:
        ...
        logger.error("Please run create_model.py first to train the model")
        raise
    except Exception as e:

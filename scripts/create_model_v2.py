...
def main():
    ...
    json.dump(list(x_train.columns),
              open(output_dir / "model_features_v2.json", 'w'))
    ...
    json.dump(defaults, open(output_dir / "defaults_v2.json", 'w'), indent=2)
    print(f"\nDefaults calculated and saved to {output_dir / 'defaults_v2.json'}")
